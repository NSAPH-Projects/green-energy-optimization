...
countries <- c('CAL', 'CAR', 'CENT', 'FlA', 'MIDA', 'MIDW', 
               'NE', 'NW', 'SE', 'SW', 'TEN', 'TEX')
solar_cap <- fread("solar_capacity_factor.csv")
...
p2a<- ggplot(co2_offset[Percent == x & Hour %in% c(12, 20)]) +
  ...
  png(paste(r, "_hourly_together.png", sep=""), width=800, height=400)
  print(p2a)
  dev.off() 
```
...
png(paste(r, "_cumulative.png", sep=""), width=800, height=400)
print(p2b)
dev.off()
```
...
png(paste("cumulative_combined.png", sep=""), width=1000, height=1000)
print(fig)
dev.off()
```
...
png(paste("daily.png", sep=""), width=800, height=600)
print(p_daily)
dev.off()
```
...
png(paste("interregional.png", sep=""), width=1000, height=1000)
...
write.csv(long_df, "total_effect.csv")
...
png(paste("total.png", sep=""), width=1000, height=500)
print(p_total)
dev.off()

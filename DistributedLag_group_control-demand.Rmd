...
for (i in (1:length(countries))){
  ...
  #dm<-dlnm_mod_list[[i]]
  save(dm,file=paste("dlnm_mod_June30_",countries[i],".Rda",sep=""))
...
countries <- c('CAL', 'CAR', 'CENT', 'FlA', 'MIDA', 'MIDW', 'NE', 'NW', 'SE', 'SW', 'TEN', 'TEX')
base_countries =c(12)#c(1,1,2,2,3,3,3,3,5,5,5,6,6,8,8,9,9,9,9,10,11,11,11,12)
other_countries =c(3)#c(10,8,5,9,6,8,10,12,2,6,11,9,11,1,10,2,4,6,11,1,2,5,9,3)
